...
fn test_git_init_external_in_worktree_pointing_worktree() {
    ...
    insta::assert_snapshot!(output, @r#"
    @  d7371f096c59 new empty commit
    │  args: jj new
    ○  91f78318ed8f import git head
    │  args: jj git init --git-repo .
    ○  1f204d9b12a9 import git refs
    │  args: jj git init --git-repo .
    ○  f63ee16f9553 add workspace 'default'
    ○  000000000000
    [EOF]
    ------- stderr -------
...
fn test_git_init_external_in_worktree_pointing_commondir() {
    ...
    let output = work_dir.run_jj(OP_LOG_COMPACT);
    insta::assert_snapshot!(output, @r#"
    @  0b1ba269013e new empty commit
    │  args: jj new
    ○  1f88feea4689 import git head
    │  args: jj git init --git-repo ../git-repo
    ○  1df148b694bc import git refs
    │  args: jj git init --git-repo ../git-repo
    ○  f63ee16f9553 add workspace 'default'
    ○  000000000000
    [EOF]
